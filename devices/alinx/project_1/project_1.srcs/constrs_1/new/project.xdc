...
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[7]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[5]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[0]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[1]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[2]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[3]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[4]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[6]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[8]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[9]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[10]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[13]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[14]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[12]}]
set_property MARK_DEBUG true [get_nets {cpu/system/memory_controller/axi4_cache/cache_ram/write$real_wstrb[11]}]
