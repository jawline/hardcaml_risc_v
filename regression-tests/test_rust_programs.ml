...
let%expect_test "Chip-8 (Rust)" =
  ...
  [%expect
    ...
    "preparing to program ram"
    RECEIVED FROM CPU VIA DMA:
    Starting upTransmitting program location11511Got handle on programInitialized framebufferInitializing op tablesInitialized op tablesInitialized, steppingFramebuffer 60
    ----------------------------------------------------------------
    ----------------------------------------------------------------
    -----------------*****-*----------------------------------------
    -**************-------------------------------------------------
    ...
    ************************----------------------------------------
    ...
    ((pc 6600)
     (general
      (0 6632 27312 0 0 0 4524 127 27676 28184 27704 8 28672 12079 4932 101 8 0 1
       7 4294950912 1029 8191 4294950913 16463 10746 2580 0 0 33018 0 1)))
    ("00000000  93 00 00 00 13 01 00 00  93 01 00 00 13 02 00 00  |................|"
     "00000010  93 02 00 00 13 03 00 00  93 03 00 00 13 04 00 00  |................|"
     "00000020  93 04 00 00 13 05 00 00  93 05 00 00 13 06 00 00  |................|"
     "00000030  93 06 00 00 13 07 00 00  93 07 00 00 13 08 00 00  |................|"
     ...
     "00000080  13 01 41 f8 ef 10 40 38  6f 00 00 00 93 02 05 00  |..A...@8o.......|"
     "00000090  13 83 05 00 93 03 06 00  73 00 00 00 13 85 02 00  |........s.......|"
     ...
     "000000d0  23 2a 91 05 13 04 05 00  b7 34 00 00 93 84 44 9e  |#*.......4....D.|"
     ...
     "00000120  b7 24 00 00 93 84 04 71  13 55 49 00 93 05 10 27  |.$.....q.UI....'|"
     "00000130  b7 3a 00 00 93 8a 4a c2  13 0b a0 00 63 62 b5 0a  |.:....J.....cb..|"
     "00000140  93 0b c1 00 37 ec f5 05  13 0c fc 0f 93 09 09 00  |....7...........|"
     "00000150  13 05 09 00 93 85 04 00  97 30 00 00 e7 80 40 80  |.........0....@.|"
     "00000160  13 09 05 00 93 85 04 00  97 20 00 00 e7 80 c0 3a  |......... .....:|"
     "00000170  b3 8c a9 40 13 95 0c 01  13 55 05 01 93 05 40 06  |...@.....U....@.|"
     "00000180  97 20 00 00 e7 80 c0 7d  93 15 15 00 13 16 55 00  |. .....}......U.|"
     ...
     "000001f0  93 05 40 06 97 20 00 00  e7 80 80 76 93 15 55 00  |..@.. .....v..U.|"
     ...
     "000002e0  97 20 00 00 e7 80 c0 67  13 09 05 00 93 85 04 00  |. .....g........|"
     "000002f0  97 20 00 00 e7 80 40 22  b3 0c aa 40 13 95 0c 01  |. ....@\"...@....|"
     "00000300  13 55 05 01 93 05 40 06  97 20 00 00 e7 80 40 65  |.U....@.. ....@e|"
     ...
     "00000380  e7 80 00 5e 93 15 55 00  13 16 25 00 33 06 b6 40  |...^..U...%.3..@|"
     ...
     "00000440  63 94 05 02 37 34 00 00  13 04 94 9e 13 06 10 01  |c...74..........|"
     ...
     "00000490  13 05 b5 af 37 36 00 00  13 06 46 b0 93 05 f0 00  |....76....F.....|"
     "000004a0  97 20 00 00 e7 80 80 98  13 01 01 f6 23 2e 11 08  |. ..........#...|"
     ...
     "00000680  b3 83 a3 00 37 35 00 00  13 05 a5 9f b3 03 75 00  |....75........u.|"
