...
struct
  ...
  let clock_domain_memory, clock_domain_cpu, clock_domain_video =
    ...
    then (
      ...
      shared_domain, shared_domain, shared_domain)
    else
      ( Hardcaml_memory_controller.Custom_clock_domain.create 500
      , Hardcaml_memory_controller.Custom_clock_domain.create 2000
      , Hardcaml_memory_controller.Custom_clock_domain.create 1000 )
  ;;
